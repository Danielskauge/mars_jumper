...
It renames all the occurrences of my_project (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the my_project folder
        os.rename(
            os.path.join(root_dir_path, "exts", "my_project", "my_project"),
            os.path.join(root_dir_path, "exts", "my_project", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "my_project"), os.path.join(root_dir_path, "exts", new_name))
